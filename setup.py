...
PACKAGEDATA = {
    ...
    'package_dir': {'wasabi': 'wasabi',
                   },
    'packages': ['wasabi',
                ],
    'scripts': ['scripts/wasabi'],
}
...
_DATA_DIR = os.path.join('wasabi', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'wasabi': data_dirs}
